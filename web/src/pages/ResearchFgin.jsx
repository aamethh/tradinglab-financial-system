        ...
        <main className="max-w-4xl mx-auto px-6 pt-28 pb-20">
          ...
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-8 mb-8">
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              Análisis comparativo en preparación para publicación pública.
            </p>
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              El análisis completo incluye: comparativa FGIN vs Fondo Global (Global Bank) vs MMG FI,
              duration analysis, credit risk assessment, peer benchmarking, y macro sensitivity.
            </p>
          </div>
