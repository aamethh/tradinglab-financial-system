        ...
        <main className="max-w-4xl mx-auto px-6 pt-28 pb-20">
          ...
          <div className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-8 mb-8">
            ...
            <p className="text-xs text-slate-600 leading-relaxed">
              El memo completo incluye: tesis de inversión, AUM growth analysis (+20.9% YoY), ROAE 21.2%,
              capital ratio 27.2%, P/B vs peers regionales, descomposición ROE, y risk matrix.
            </p>
          </div>
